...
const Header = () => {
  ...
  return (
    <header className="border-b border-black bg-black/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 sm:py-4">
            ...
            <div className="flex items-center space-x-2">
              <Link to="/organizer/events/new">
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="border-white text-black hover:bg-white/10 hover:text-white flex items-center gap-1 h-8 px-3"
        ...
        >
          <div className="flex flex-col space-y-4 py-4 border-t border-white/10 mt-4">
            <a 
              href="https://www.instagram.com/byblos.exp" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <Link 
              ...
              className="flex items-center text-white hover:bg-white/10 px-2 py-2 rounded text-base"
            >
