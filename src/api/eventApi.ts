...
export const purchaseTicketsWithPaystack = async (data: PurchaseTicketData & { reference: string }): Promise<TicketPurchaseResponse> => {
  const response = await axios.post(`${API_URL}/tickets/paystack`, data, {
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
    }
