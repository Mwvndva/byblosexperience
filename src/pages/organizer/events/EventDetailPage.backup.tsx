...
import { ComplimentaryTicketsManager } from '@/components/events/ComplimentaryTicketsManager';
      ...
      <Tabs defaultValue="overview" className="w-full mt-6">
        ...
        <TabsContent value="complimentary" className="space-y-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-medium">Complimentary Tickets</h3>
                <p className="text-sm text-muted-foreground">
                  Manage complimentary tickets for your event
                </p>
              </div>
            </div>
